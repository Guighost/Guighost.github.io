    ...
    _createUI: function() {
      ...
      game._$start.find('.blockrain-option-btn').click(function (event) {
          ...
          game._$optionsSelect = $(
              ...
              '<a id="retroBtn" class="blockrain-btn cracked-btn optionBtns">' + "Cracked" + '</a>' +
              '</div>' +
              '</div>' +
              '</div>').show();
          ...
          game._$optionsSelect.find('.cracked-btn').click(function (event) {
              event.preventDefault();
              themeNameGG = 'cracked';
              loadThemeGG(themeNameGG); game._$optionsSelect.hide();
...
window.BlockrainThemes = {
  ...
  'cracked': {
      ...
      backgroundGrid: 'data:image/png;base64,',
      complexBlocks: {
          line: ['assets/blocks/custom3/line.png', 'assets/blocks/custom3/line.png'],
          square: ['assets/blocks/custom3/square.png'],
          arrow: 'assets/blocks/custom3/arrow.png',
          rightHook: ['assets/blocks/custom3/rightHook.png'],
          leftHook: 'assets/blocks/custom3/leftHook.png',
          rightZag: ['assets/blocks/custom3/rightZag.png'],
          leftZag: 'assets/blocks/custom3/leftZag.png'
      }
  },
  'candy': {
    background: '#040304',
