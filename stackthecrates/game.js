...
playGame.prototype = {
    ...
    create: function () {
        ...
        var ground2 = game.add.sprite(game.width / 8, game.height, "ground2");
        ground2.y = game.height - (game.height / 2);
        var ground3 = game.add.sprite((game.width - (game.width / 8)), game.height, "ground2");
        ground3.y = game.height - (game.height / 2);
        ...
        game.physics.box2d.enable(ground2);
        ground2.body.friction = 1;
        ground2.body.static = true;
        ground2.body.setCollisionCategory(1);
        this.cameraGroup.add(ground2);

        game.physics.box2d.enable(ground3);
        ground3.body.friction = 1;
        ground3.body.static = true;
        ground3.body.setCollisionCategory(1);
