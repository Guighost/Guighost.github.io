...
function hover(i) {
    var hovertextNow = "";
    if (i == 1) { hovertextNow = "Hypothesis" }
    else if (i == 2) { hovertextNow = "Test Hypothesis" }
    else if (i == 3) { hovertextNow = "Close Test" }
    else if (i == 4) { hovertextNow = "Restart Level" }
    else if (i == 5) { hovertextNow = "Select Level" }
    else if (i == 6) { hovertextNow = "Help" }
    ;
    document.getElementById("buttonText").innerHTML = hovertextNow;
}